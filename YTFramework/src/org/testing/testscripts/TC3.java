...
public class TC3  extends Base{
	...
	public void test() throws InterruptedException, IOException
	{
		...
		Assertion1.assert1(driver.getCurrentUrl(),"https://www.youtube.com/feed/trending?bp=6gQJRkVleHBsb3Jl","TC3","Login Successfully for TC3" );
		
		Screenshot.takeScreenshot(driver, "D://Classes//Java Selenium//Screenshot//TC3.png");
